                ...
                <div className="relative overflow-hidden bg-[#0d0d0d] px-6 pt-6 pb-5 md:px-8">
                    ...
                    <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <h1 className="text-xl font-bold tracking-tight text-white md:text-2xl">Manajemen Komunitas</h1>
                            <p className="mt-0.5 text-sm text-white/50">Kelola semua post dari seluruh tenant di platform.</p>
                        </div>
                    </div>
                </div>
