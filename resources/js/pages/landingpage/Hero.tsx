        ...
        <section className="hero-gradient relative overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(105,190,125,0.22),transparent_30%),radial-gradient(circle_at_top_right,rgba(222,248,229,0.9),transparent_28%),linear-gradient(180deg,#f8fff9_0%,#ffffff_52%,#eaf8ed_100%)] px-5 pt-12 pb-20 sm:px-6 lg:px-10 lg:pt-24 lg:pb-28">
            ...
            <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
                            ...
                            {['R', 'A', 'B', 'D'].map((item, index) => (
                                <span
                                    ...
                                    className={`flex size-9 items-center justify-center rounded-full border-2 border-white text-xs font-black ${
                                        index === 0 ? 'bg-[#D8F380]' : index === 1 ? 'bg-[#BDB5FF]' : index === 2 ? 'bg-[#FF8C67]' : 'bg-[#79D7FF]'
                                    }`}
                                >
                                    {item}
                                </span>
                ...
                <div data-reveal className="reveal-hidden relative min-h-[520px] sm:min-h-[590px]">
                    <div className="absolute top-[5%] left-[8%] size-24 rotate-12 rounded-[2rem] bg-[#D8F380] opacity-80 blur-[1px]" />

                    <div className="absolute top-[20%] right-[2%] size-20 rounded-full bg-[#8bd39b] opacity-80" />

                    <div className="absolute bottom-[8%] left-[3%] size-16 rounded-full bg-[#c8efd1] opacity-90" />

                    <div className="absolute top-[5%] right-[4%] h-[88%] w-[88%] rotate-[5deg] rounded-[3rem] border-2 border-[#D8F380] bg-[#D8F380]/80 shadow-[0_25px_60px_rgba(122,145,28,0.25)]" />
                                        ...
                                        <svg viewBox="0 0 300 120" className="absolute inset-0 h-full w-full" preserveAspectRatio="none">
                                            <defs>
                                                <linearGradient id="chartFill" x1="0" x2="0" y1="0" y2="1">
                                                    ...
                                                    <stop offset="100%" stopColor="#5E4BF2" stopOpacity={0.02} />
                                                </linearGradient>
                                            </defs>
                                            ...
                                            <circle cx="227" cy="35" r="5" fill="#D8F380" stroke="#5E4BF2" strokeWidth="2" />

                                            <circle cx="150" cy="46" r="4" fill="#5E4BF2" />

                                            <circle cx="300" cy="12" r="4" fill="#5E4BF2" />
                                        </svg>
                                    </div>
                    ...
                    <div className="animate-float-delay-2 absolute right-[-1%] bottom-[12%] z-20 w-[190px] rotate-3 rounded-2xl border border-white bg-[#FF8C67] p-3.5 text-white shadow-2xl sm:right-[-4%]">
                        <div className="flex items-center gap-3">
