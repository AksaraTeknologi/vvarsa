    ...
    const steps = [
        {
            step: '01',
            icon: Boxes,
            title: t('landing.howItWorks.step1.title', 'Masukkan data'),
            text: t('landing.howItWorks.step1.text', 'Input produk, stok, supplier, dan harga hanya sekali, lalu semuanya otomatis tersusun.'),
            color: '#5E4BF2',
            tint: 'from-[#5E4BF2]/30 to-[#17192E]',
            badge: t('landing.howItWorks.step1.badge', 'mulai'),
        },
        {
            step: '02',
            icon: WalletCards,
            title: t('landing.howItWorks.step2.title', 'Kelola transaksi'),
            text: t('landing.howItWorks.step2.text', 'Kasir, pesanan, pembayaran, dan aktivitas harian berjalan lebih cepat tanpa bolak balik data.'),
            color: '#FF8C67',
            tint: 'from-[#FF8C67]/30 to-[#17192E]',
            badge: t('landing.howItWorks.step2.badge', 'jalan'),
        },
        {
            step: '03',
            icon: BarChart3,
            title: t('landing.howItWorks.step3.title', 'Lihat hasil'),
            text: t('landing.howItWorks.step3.text', 'Dashboard real-time menampilkan omzet, stok, dan profit tanpa perlu rekap manual.'),
            color: '#79D7FF',
            tint: 'from-[#1777FB]/30 to-[#17192E]',
            badge: t('landing.howItWorks.step3.badge', 'naik'),
        },
    ];
    ...
    return (
        ...
        >
            ...
            <div className="relative mx-auto max-w-7xl">
                <div data-reveal className="reveal-hidden text-center">
                    <span className="rounded-full bg-[#D8F380] px-4 py-2 text-[10px] font-black uppercase text-[#17182A]">
                        {t('landing.howItWorks.badge', 'Cara kerja VVARSA')}
                    </span>

                    <h2 className="mx-auto mt-4 max-w-4xl text-[2rem] font-black leading-tight tracking-[-0.04em] sm:text-4xl">
                        {t('landing.howItWorks.title1', 'Dari data ribet,')}
                        <span className="text-[#D8F380]">
                            {' '}
                            {t('landing.howItWorks.titleHighlight', 'jadi bisnis yang bergerak.')}
                        </span>
                    </h2>

                    <p className="mx-auto mt-3 max-w-2xl text-sm font-semibold text-white/65 sm:text-base">
                        {t('landing.howItWorks.description', 'Semua proses penting dari input data sampai laporan keputusan dibuat dalam satu flow yang simpel, cepat, dan lebih rapi.')}
                    </p>
                </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="mt-7 flex items-center justify-between">
                                    ...
                                    <span className="text-sm font-black text-white/60">{item.step}</span>
                                </div>

                                <p className="mt-3 text-sm font-semibold leading-relaxed text-white/65">{item.text}</p>
