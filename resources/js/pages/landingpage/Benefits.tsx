        ...
        <section data-reveal id="manfaat" className="reveal-hidden relative mx-auto max-w-7xl overflow-visible px-6 py-20 lg:px-10 lg:py-24">
            ...
            <div className="relative grid items-center gap-10 lg:grid-cols-[0.8fr_1.2fr]">
                ...
                <div className="grid gap-8 sm:grid-cols-2" style={{ perspective: '1400px' }}>
                    ...
                    >
                        <div className="pointer-events-none absolute top-[-35px] right-[-35px] size-32 rounded-full bg-[#FFE7E7] opacity-60 blur-[1px]" />

                        <div className="pointer-events-none absolute bottom-[-20px] left-[-20px] size-24 rounded-full bg-[#FFF0F0]" />

                        <div className="relative z-10">
                            <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-[#FFE9E9] px-4 py-2 text-[10px] font-black tracking-wider text-[#D65353] uppercase">
