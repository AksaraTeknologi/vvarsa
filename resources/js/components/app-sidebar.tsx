...
const ROLE_THEME = {
    admin: {
        ...
        bgHover: 'group-hover:bg-admin-hover hover:bg-admin-hover',
        textHover: 'group-hover:text-admin-accent hover:text-admin-accent',
    ...
    owner: {
        ...
        bgHover: 'group-hover:bg-owner-hover hover:bg-owner-hover',
        textHover: 'group-hover:text-owner-accent hover:text-owner-accent',
    ...
    supervisor: {
        ...
        bgHover: 'group-hover:bg-supervisor-hover hover:bg-supervisor-hover',
        textHover: 'group-hover:text-supervisor-accent hover:text-supervisor-accent',
    ...
    staff: {
        ...
        bgHover: 'group-hover:bg-staff-hover hover:bg-staff-hover',
        textHover: 'group-hover:text-staff-accent hover:text-staff-accent',
